            ...
            <div className='total_section'>
                ...
                <div className="select">
                    <select id="quantity" onChange={thompsonValues}>
                        <option value="1 Piece : 500$">1 Piece : 500$</option>       
                        <option value="5 Pieces : 2500$">5 Pieces : 2500$</option>
                        <option value="10 Pieces : 5000$">10 Pieces : 5000$</option>
                        <option value="20 Pieces : 10000$">20 Pieces : 10000$</option>
                    </select>
            ...
            <div className='total_section'>
                ...
                <div className="select">
                    <select id="quantity" onChange={modelValues}>
                        <option value="1 Piece : 250$">1 Piece : 250$</option>       
                        <option value="5 Pieces : 1250$">5 Pieces : 1250$</option>
                        <option value="10 Pieces : 2500$">10 Pieces : 2500$</option>
                        <option value="20 Pieces : 5000$">20 Pieces : 5000$</option>
                    </select>
            ...
            <div className='total_section'>
                ...
                <div className="select">
                    <select id="quantity" onChange={remingtonValues}>
                        <option value="1 Piece : 400$">1 Piece : 400$</option>       
                        <option value="5 Pieces : 2000$">5 Pieces : 2000$</option>
                        <option value="10 Pieces : 4000$">10 Pieces : 4000$</option>
                        <option value="20 Pieces : 8000$">20 Pieces : 8000$</option>
                    </select>
